...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#050505] via-[#0b0b0b] to-[#050505] px-6 py-24 sm:py-32 lg:px-8">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button
            asChild
            size="lg"
            className="bg-[#5B7335] hover:bg-[#4D632D] text-zinc-950 px-8 py-6 h-auto text-lg"
          >
            <a href="#cta">
              Join the waitlist
